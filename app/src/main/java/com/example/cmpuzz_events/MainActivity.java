    ...
    private void setupNavigationForUserRole() {
        ...
        if(currentUser.isAdmin())
        {
            ...
            AppBarConfiguration appBarConfiguration = new AppBarConfiguration.Builder(
                    R.id.navigation_browse,R.id.navigation_history ,R.id.navigation_browse_users, R.id.navigation_notification_log, R.id.navigation_browse_images)
                    .build();
            ...
            if (currentUser.isAdmin()) {
                appBarConfiguration = new AppBarConfiguration.Builder(
                        ...
                        R.id.navigation_browse_users, R.id.navigation_notification_log, R.id.navigation_browse_images)
                        .build();
            }
